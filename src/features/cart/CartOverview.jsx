...
import { getPizzaPrice, getPizzaQuantity } from './cartSlice';
import { formatCurrency } from '../../utils/helpers';

function CartOverview() {
  const totalPizzaQuantity = useSelector(getPizzaQuantity);
  const totalPizzaPrice = useSelector(getPizzaPrice);
